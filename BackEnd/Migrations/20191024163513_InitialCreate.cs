    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail" },
...
", "commodo", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "esse", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "in", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "sunt", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "ut", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "aliquip", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "duis", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
...
", "sunt", "http://placehold.it/32x32", "reillyholden@jamnation.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1u, " Colorado", 1u, -2.6945920000000001, "159 Irving Street", "proident", -14.284725999999999, "sunt" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 2u, " Wisconsin", 2u, -1.662758, "909 Louisa Street", "quis", 39.233745999999996, "do" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 3u, " Texas", 3u, -1.8960090000000001, "885 Oxford Walk", "laborum", -48.584065000000002, "in" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 4u, " Arizona", 4u, 0.187475, "217 Dunne Place", "exercitation", 23.450187, "laboris" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 5u, " Virgin Islands", 5u, -4.7580780000000003, "165 Kimball Street", "nostrud", -8.6560410000000001, "duis" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 6u, " North Dakota", 6u, -2.6139230000000002, "255 Bedell Lane", "irure", -38.573397999999997, "id" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 7u, " Puerto Rico", 7u, -3.4436460000000002, "566 Clay Street", "dolore", -16.477741000000002, "some" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 8u, " Alaska", 8u, 0.37073800000000001, "755 Kings Place", "laborum", -35.696264999999997, "officia" });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "AddressID", "County", "GarageID", "Latitude", "LineOne", "LineTwo", "Longitude", "PostCode" },
                values: new object[] { 9u, " Nebraska", 9u, -2.8938299999999999, "250 Fleet Street", "ipsum", -22.981099, "sit" });
