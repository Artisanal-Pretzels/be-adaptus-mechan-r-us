    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1u, 80.0, "Manchester's Leading Accident Repair Centre. Sapphire Garage was founded 25 years ago in one small unit on a trading estate in East Manchester.", "Sapphire Garage", "http://www.sapphiregarage.co.uk/wp-content/uploads/2017/05/sapphire_garage_logo.png", "payment@sapphiregarage.co.uk", 1u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 10u, 55.0, "Best Auto services in town.", "Z Cars Auto Services", "http://placehold.it/32x32", "payment@zcarsautoservices.com", 10u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 8u, 79.0, "Established since 1920, Bradford Garage Ltd has been owned by the Spence family since 1963.", "Bradford Garage", "http://placehold.it/32x32", "payment@bradfordgarage.co.uk", 8u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 7u, 87.0, "We are one of the leading car repair garages serving customers in Manchester. All mechanic services are performed by highly qualified mechanics.", "Platt Lane Garage", "http://placehold.it/32x32", "payment@plattlanegarage.co.uk", 7u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 6u, 74.0, "Small team of dedicated mechanics with long track record of excellent service and recovery", "Birch Lane Garage", "http://placehold.it/32x32", "charlie@birchlanegarage.com", 6u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 5u, 90.0, "DC Motor Engineers Garage is a premium MOT Testing Centre, car servicing and repair facility. Based in the centre of Manchester, 2 minutes walk from oxford road station and the University, our garage offers an unparalleled service.", "DC Motor Engineers", "http://placehold.it/32x32", "payment@mot-test-manchester.co.uk", 5u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 9u, 40.0, "Local garage with excellent services", "A Everall Garage", "http://placehold.it/32x32", "payment@aeverallgarage.com", 9u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 3u, 60.0, "Alternator and Starter Motor specialists. Servicing vehicles in Salford and Greater Manchester for over 35 years.", "EMS GARAGE", "http://placehold.it/32x32", "payment@emsgarage.co.uk", 3u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 2u, 50.0, "Local garage run by two mechanics", "Queens Garage", "http://placehold.it/32x32", "admin@queensgarage.com", 2u });

            migrationBuilder.InsertData(
                table: "Garages",
                columns: new[] { "GarageID", "BasePrice", "Description", "GarageName", "ImagePath", "PaymentEmail", "UserID" },
                values: new object[] { 4u, 68.0, "One of the largest independent Service Centres and MOT Stations in Manchester City Centre.", "Duffy Motors", "https://duffymotors.co.uk/wp-content/themes/duffy/library/img/logo.png", "payment@duffymotors.co.uk", 4u });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 10u, 10u, 20u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 7u, 7u, 17u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 1u, 1u, 11u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 6u, 6u, 16u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 5u, 5u, 15u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 9u, 9u, 19u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 4u, 4u, 14u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 8u, 8u, 18u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 3u, 3u, 13u });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceID", "GarageID", "UserID" },
                values: new object[] { 2u, 2u, 12u });
